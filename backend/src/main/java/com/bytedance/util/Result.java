...
public class Result<T> implements Serializable {
  ...
  public static <T> Result<T> error(ResultCode resCode) {
    return new Result<>(resCode.getCode(), resCode.getMessage(), null);
  }

  public static <T> Result<T> error(ResultCode resCode, String message, T data) {
    return new Result<>(resCode.getCode(), message, data);
  }

  public static <T> Result<T> error(ResultCode resCode, String message) {
    return new Result<>(resCode.getCode(), message, null);
  }
